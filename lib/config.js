...
module.exports = function( argv ) {
    ...
    var cfg  = {
        ...
        options : {
            workers         : process.env.PHANTOM_CLUSTER_NUM_WORKERS || 0,   // Max number of workers ( clusters )
    ...
    args
        ...
        .option('-P , --port [number]','Port this server will listen on, default 3030',function(value){
            return checkValueNumber(value,3000,64000,true,args,"port must be a number between 1000 and 6400 but was : "+value);
        })
